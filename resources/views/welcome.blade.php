                        ...
                        <div class="col-12">
                            ...
                            <div class="dropdown float-right">
                                <a class="btn btn-lg btn-light dropdown-toggle products-actual-count" data-toggle="dropdown" role="button"
                                   aria-haspopup="true" aria-expanded="false">10<span class="caret"></span></a>
...
{{--                            </div>--}}
            ...
            <form class="col-md-4 order-md-1 col-lg-3 sidebar-filter">
                <h3 class="mt-0 mb-5">{{ __('shop.welcome.products') }}<span
                        class="text-primary"> {{ count($products) }}</span></h3>
                ...
                <a href="#" class="btn btn-lg btn-block btn-primary mt-5"
                   id="filter_button"><i class="fas fa-search"></i> {{ __('shop.welcome.filter') }}</a>
            </form>
